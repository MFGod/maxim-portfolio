 ...
 *
 * План — не заглушка вместо трёхмерного мира, а его равноправное представление.
 * Он показывается там, где сцену поднимать нельзя (мобильный, «покой», старая
 * машина), и рисуется из тех же координат, что и мир, поэтому расходиться им
 * не с чем.
 */
