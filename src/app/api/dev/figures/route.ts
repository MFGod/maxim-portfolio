 ...
 *
 * Панель подбора живёт в браузере, а расстановка — в исходниках, и до сих пор
 * мост между ними был ручной: скопировать кусок, вставить в файл. Кнопка
 * «Сохранить» ходит сюда.
 *
 * Ручка **только для разработки**: в любой другой среде она отвечает 404 и
 * ничего не делает. Пишется ровно один известный файл, путь не приходит
 * снаружи, а каждая фигура проверяется тем же разбором, что и черновик из
 * `localStorage`, — тело запроса здесь такие же чужие данные.
 */
