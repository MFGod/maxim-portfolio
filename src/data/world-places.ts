 ...
 *
 * Новой геометрии на ландшафт не добавляется. Глава — уже расставленная в карте
 * благодать, проект — уже стоящее подземелье, катакомбы, арена или склеп героя.
 * Издалека они горят слабо, разгораются при входе камеры в свой регион.
 *
 * Координаты получены не на глаз: каталог из 256 ориентиров снят с живой сцены,
 * главы разнесены перебором пар с минимальным разносом, проекты подтянуты к
 * своей главе по близости. Раскладка по названиям регионов не годится — в этой
 * карте регионы чередуются, и главы сбивались в кучу.
 */
