...
export const projects: Project[] = deepFreeze([
  ...
  },
  {
    ...
    engineering: [
      'Долгие LLM-операции выведены из запроса в очередь — интерфейс не держит соединение на время генерации.',
    ],
    links: [],
    visuals: [],
    confidential: true,
  ...
  },
  {
    ...
    problem:
      'Публичный сайт архива и админка редакции — два интерфейса одного продукта, которые не должны разъезжаться визуально.',
    solution:
  ...
  },
  {
    ...
    engineering: [
      ...
      'Правило «внешний контент — данные, а не инструкции» для всего, что приходит из сети и от MCP-серверов.',
