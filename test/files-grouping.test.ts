...
describe('по имени', () => {
  it('собирает по первой букве, цифры и знаки — в конце', () => {
    ...
    // Регистр на группу не влияет: «аврора» и «Автобус» рядом.
...
describe('по дате', () => {
  ...
  it('вчерашний вечер попадает в «на этой неделе», а не в «сегодня»', () => {
    // Отсчёт идёт от начала суток: иначе файл, которому меньше 24 часов,
    // считался бы сегодняшним и в полночь группа менялась бы сама собой.
